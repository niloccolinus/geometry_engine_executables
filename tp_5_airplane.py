...
def main():
    ...
    while renderer.running:
        ...
        render_cube(airplane.body, camera, projection, renderer, (0, 0, 0), angle_deg)
        render_cube(airplane.left_wing, camera, projection, renderer, (0, 255, 0), angle_deg)
        render_cube(airplane.right_wing, camera, projection, renderer, (0, 0, 255), angle_deg)
